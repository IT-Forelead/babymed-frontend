...
const isShowCloseSidebarBtn = computed(() => useModalStore().isModalOpen || useModalStore().isOpenPaymentStatusChangerModal || useModalStore().isOpenAddVisitModal || useModalStore().isOpenOperationExpenseInfo || useModalStore().isOpenPrintModal || useModalStore().isOpenPrintPdfModal || useModalStore().isOpenAddServiceModal || useModalStore().isOpenEditServiceModal || useModalStore().isOpenDeleteAlertModal || useModalStore().isOpenAddUserModal)
</script>
<template>
