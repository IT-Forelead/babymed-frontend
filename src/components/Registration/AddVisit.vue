...
import SelectOptionPatient from '../SelectOptionPatient.vue'
...
<template>
  <div class="space-y-5">
    ...
    <div class="flex justify-center">
      <div @click="addItems()" class="w-10 h-10 bg-lime-300 hover:bg-lime-400 cursor-pointer hover:scale-110 transition-all duration-300 flex items-center justify-center rounded-full text-3xl p-1">
        <PlusIcon />
      </div>
    </div>
