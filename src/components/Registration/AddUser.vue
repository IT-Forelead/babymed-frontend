...
<template>
  <div class="bg-white rounded-lg mt-3 p-3 space-y-5">
    ...
    <div @click="submitUserData()" :class="isLoading ? 'bg-gray-600' : 'bg-gray-900 hover:bg-gray-800 cursor-pointer'" class="w-full py-3 text-white rounded-lg flex items-center justify-center">
