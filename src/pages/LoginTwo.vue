...
<template>
  <div class="flex w-full h-screen overflow-hidden">
    <div class="relative basis-1/3 max-h-screen p-8">
      <img src="/vite.svg" class="p-2 border border-gray-300 rounded-lg" alt="@" />
          ...
          <div>
            ...
            <label for="password">
              <div class="relative">
                ...
                <EyeIcon v-if="hidePassword" @click="togglePassword()" class="text-gray absolute z-10 top-1/2 -translate-y-1/2 right-3 w-5 h-5 cursor-pointer" />
                <EyeSlashIcon v-else @click="togglePassword()" class="absolute z-10 top-1/2 -translate-y-1/2 right-3 w-5 h-5 cursor-pointer" />
              </div>
            </label>
          </div>
